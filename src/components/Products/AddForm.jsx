...
export const AddForm = ({ setLoading, setIsAdd }) => {
    ...
    const uploadImage = async (base64EncodedImage, base64EncodedImages) => { 
        ...
        await fetch(process.env.REACT_APP_API_URL + '/products', {
            method: "POST",
            body: JSON.stringify({ name, description: desc, config: document.getElementById('mytable3').innerHTML.toString(), category, brand, costPrice, normalPrice, quantity, unit, imageUrl: base64EncodedImage, imageList: base64EncodedImages }),
            ...
            <div className='body-form_right'>
                ...
                <div className='button-top'>
                    <div className='tabs'> 
                        ...
                        <div onClick={() => setIsDesc(false)} className={`tab ${!isDesc}`}>Thông số kỹ thuật</div>
                    </div>
                    <button style={{margin: '10px', borderRadius: '5px', padding: '5px 20px', border: 'none', outline: 'none'}}><CheckCircleRoundedIcon /> Tạo mới</button>
                </div>
                        ...
                        <div className='inputs'>
                            <div className='inputs-buttons'> 
                                ...
                                <span onClick={() => {
                                    ...
                                    setConfigName('');
                                    setConfigDetail(''); 
                                }} className='button'>Thêm cấu hình</span>
                                <span onClick={() => {
                                    setConfigObjects([])
